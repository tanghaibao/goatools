...
def test_desc2nts():
    ...
    desc2nts = sortobj.get_desc2nts_fnc(
        hdrgo_prt=True, section_prt=None, top_n=None, use_sections=True
    )
    assert desc2nts["hdrgo_prt"]
    h1a = set(nt.GO for sec, nts in desc2nts["sections"] for nt in nts)
    num_sections = len(desc2nts["sections"])
    assert (
        desc2nts["sections"] == sortobj.get_desc2nts_fnc()["sections"]
    ), "**FAILED: Default values"
    _chk_d2(desc2nts, num_sections)

    desc2nts = sortobj.get_desc2nts_fnc(
        hdrgo_prt=True, section_prt=True, top_n=None, use_sections=True
    )
    assert desc2nts["hdrgo_prt"]
    ...
    desc2nts = sortobj.get_desc2nts_fnc(
        hdrgo_prt=True, section_prt=False, top_n=None, use_sections=True
    )
    ...
    desc2nts = sortobj.get_desc2nts_fnc(
        hdrgo_prt=False, section_prt=None, top_n=None, use_sections=True
    )
    ...
    desc2nts = sortobj.get_desc2nts_fnc(
        hdrgo_prt=False, section_prt=True, top_n=None, use_sections=True
    )
    assert not desc2nts["hdrgo_prt"]
    _chk_d2(desc2nts, num_sections)

    desc2nts = sortobj.get_desc2nts_fnc(
        hdrgo_prt=False, section_prt=False, top_n=None, use_sections=True
    )
    assert set(desc2nts.keys()) == D1_FLDS
    assert not desc2nts["hdrgo_prt"]
    ...
    desc2nts = sortobj.get_desc2nts_fnc(
        hdrgo_prt=True, section_prt=None, top_n=None, use_sections=False
    )
    assert desc2nts["hdrgo_prt"]
    _chk_flat(desc2nts, h1a)

    desc2nts = sortobj.get_desc2nts_fnc(
        hdrgo_prt=True, section_prt=True, top_n=None, use_sections=False
    )
    assert desc2nts["hdrgo_prt"]
    _chk_flat(desc2nts, h1a)

    desc2nts = sortobj.get_desc2nts_fnc(
        hdrgo_prt=True, section_prt=False, top_n=None, use_sections=False
    )
    assert desc2nts["hdrgo_prt"]
    _chk_flat(desc2nts, h1a)

    desc2nts = sortobj.get_desc2nts_fnc(
        hdrgo_prt=False, section_prt=None, top_n=None, use_sections=False
    )
    assert not desc2nts["hdrgo_prt"]
    _chk_flat(desc2nts, h0a)

    desc2nts = sortobj.get_desc2nts_fnc(
        hdrgo_prt=False, section_prt=True, top_n=None, use_sections=False
    )
    assert not desc2nts["hdrgo_prt"]
    _chk_flat(desc2nts, h0a)

    desc2nts = sortobj.get_desc2nts_fnc(
        hdrgo_prt=False, section_prt=False, top_n=None, use_sections=False
    )
    assert not desc2nts["hdrgo_prt"]
    _chk_flat(desc2nts, h0a)
...
def _get_sortobj():
    ...
    godag = get_godag(fin_godag, prt=None, optional_attrs=["relationship"])
