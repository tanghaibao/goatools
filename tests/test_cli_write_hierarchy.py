...
__copyright__ = (
    "Copyright (c) 2017-present, DV Klopfenstein. Haiboa Tang. All rights reserved."
)
...
def test_cli():
    ...
    args_exp = [
        ...
        (
            ["CC", "--concise"],
            {"dag": "go-basic.obo", "dash_len": 6, "GO": ["CC"], "concise": True},
        ),
        (["--no_indent"], {"dag": "go-basic.obo", "dash_len": 6, "no_indent": True}),
        (
            ["--concise", "--no_indent"],
            {"dag": "go-basic.obo", "dash_len": 6, "concise": True, "no_indent": True},
        ),
    ]
