...
NAME2GOIDS = {
    "smell": set(
        ["GO:0007608", "GO:0050911"]  # sensory perception of smell
    ),  # detection of chemical stimulus involved in sensory perception of smell
    "secretory": set(
        ["GO:0030141", "GO:0034774"]  # CC 20 L06 D07 AC  P... p... secretory granule
    ),  # CC  8 L05 D06 ABD P... .... secretory granule lumen
...
def test_plot_part_of():
    ...
    names = NAME2GOIDS
    # names = ["heartjogging"]
    with open(fout_log, "w", encoding="utf-8") as prt:
        for name in names:
...
class _Run(object):
    ...
    def plot_all(self, goids, name, prt=sys.stdout):
        ...
        gopltdag.plt_dag(
            os.path.join(REPO, "a_relationship_{NAME}_r0.png".format(NAME=name))
        )
        ...
        gopltdag.plt_dag(
            os.path.join(REPO, "a_relationship_{NAME}_partof.png".format(NAME=name))
        )
        ...
        gopltdag.plt_dag(
            os.path.join(REPO, "a_relationship_{NAME}_r1.png".format(NAME=name))
        )
    ...
    def wr_subobo(self):
        ...
        for name, goids in NAME2GOIDS.items():
            ...
            download_go_basic_obo(fin_obo, prt=sys.stdout)
